...
//           <Button variant={'outline'} className='w-xs'><Mail /> Email </Button>
//           <Button variant={'outline'} className='w-xs'><Mail /> WhatsApp </Button>
//           <Button variant={'outline'} className='w-xs'><Mail /> Telegram </Button>
//         </div>
//       </div>
